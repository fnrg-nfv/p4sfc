...
def main(p4info_file_path, bmv2_file_path, server_port):
    ...
    print 'Switch controller start successfully...'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        action="store",
        required=False,
        default='../configurable_p4_dp/build/p4sfc_template.p4.p4info.txt')
    parser.add_argument('--bmv2-json', help='BMv2 JSON file from p4c',
                        type=str, action="store", required=False,
                        default='../configurable_p4_dp/build/p4sfc_template.json')
