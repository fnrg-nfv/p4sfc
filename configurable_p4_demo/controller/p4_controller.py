...
class P4Controller(object):
    ...
    def insert_IPRewriter_entry(self, chain_id, stage_id, entry_info):
        ...
        # table_entry = self.p4info_helper.buildTableEntry(
        #     table_name="MyIngress.elementControl_0.ipRewriter.IpRewriter_exact",
        #     match_fields={
        #         "hdr.sfc.chainId": 0,
        #         "meta.stageId": 3,
        #         "hdr.ipv4.srcAddr": 0x01010101,
        #         "hdr.ipv4.dstAddr": 0x01010101,
        #         "hdr.ipv4.protocol": 0x01,
        #         "hdr.tcp_udp.srcPort": 0x0101,
        #         "hdr.tcp_udp.dstPort": 0x0101,
        #     },
        #     action_name="MyIngress.elementControl_0.ipRewriter.change_src_addr_and_port",
        #     action_params={
        #         "srcAddr": 0x02020202,
        #         "srcPort": 0x0202,
        #     }
        ...
        print "Installed new table entry on IPRewriter"


if __name__ == '__main__':
    p4Controller = P4Controller('../build/p4sfc_template.p4.p4info.txt')
    ...
    p4Controller.insert_IPRewriter_entry(0, 3, entry_info)
