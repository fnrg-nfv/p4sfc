...
control IpRewriter(inout headers hdr,
    ...
    table IpRewriter_exact {
        ...
        // size = 1024;
        const entries = {
            (0, 512, 0, 0x0a000101, 0x0a000304, 0x162E, 0x04d2): rewrite(0x0a0a0a0a, 0x0b0b0b0b, 0x1111, 0x2222);
...
control Firewall(inout headers hdr,
    ...
    table Firewall_ternary {
        ...
        // size = 1024;
        const entries = {
            (0, 256, 0, 0x00000000 &&& 0x00000000, 0x0a000303 &&& 0xffffffff, 0x00 &&& 0x00, 0x0000 &&& 0x0000, 0x0000 &&& 0x0000): drop();
        }
    }
