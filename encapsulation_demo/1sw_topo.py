...
def main():
    ...
    net = Containernet(controller=Controller,
                       switch=P4Switch)
    ingress_switch = net.addSwitch('ingress_switch',
                                   sw_path=args.behavioral_exe,
                                   json_path='./build/ingress.json',
                                   thrift_port=args.thrift_port,
                                   pcap_dump=args.pcap_dump,
                                   log_file=args.log_dir)

    parse_switch = net.addSwitch('parse_switch',
                                   sw_path=args.behavioral_exe,
                                   json_path=args.json,
                                   thrift_port=args.thrift_port,
                                   pcap_dump=args.pcap_dump,
    ...
    egress_switch = net.addSwitch('egress_switch',
                                   sw_path=args.behavioral_exe,
                                   json_path=args.json,
                                   thrift_port=args.thrift_port,
                                   pcap_dump=args.pcap_dump,
    ...
    net.addLink(host[0], ingress_switch)
    net.addLink(parse_switch, ingress_switch)
    net.addLink(parse_switch, egress_switch)
    net.addLink(host[1], egress_switch)
